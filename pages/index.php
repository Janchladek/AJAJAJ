...
<main class="container">
    <h1 class="m-4 text-uppercase"> uživateľia</h1>
   <ul class="list-group">
   ...
   <?php foreach ($users as $user) : ?>
    <li class="list-group-item list-group-item-action d-flex row align-items-center">     
            ...
            <div class="col-2 d-flex justify content-center">
                <a style="margin-right: 25px" href="../pages/profile.php<?php echo "?user=".$user["id"]; ?>"class="btn btn-success">Profil</a>
